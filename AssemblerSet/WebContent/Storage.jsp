...
<c:choose>  
  ...
  <tr>
  <td><img alt="storage" src="${storage.value.getImage() }" width="80" height="80"></td>
  <td><c:out value="${storage.value.getBrand()}"></c:out>&nbsp;<c:out value="${storage.value.getType()}"></c:out></td>
  <td><c:out value="${storage.value.getModel()}"></c:out></td>
